...
import SmartContractBase from "../contracts/smartContractBase";

class Vault_ extends SmartContractBase {
...
const ttddVault_old_ = new Vault_(TTDDVaultAddress);

export const ttddVault_old = async () => await ttddVault_old_.init();
